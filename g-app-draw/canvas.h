...
// drawing primitives
inline void LineWidth( Cairo::RefPtr<Cairo::Context> const & cr, SLineWidth const & w )
        {
        cr->set_line_width(w.w);
        }


inline void Color( Cairo::RefPtr<Cairo::Context> const & cr, SColor const & c )
        {
...
inline void Line(Cairo::RefPtr<Cairo::Context> const & cr, SLine const & tLine )
        {
        MoveTo(cr, tLine.a);
        LineTo(cr, tLine.b);
        cr->stroke();
